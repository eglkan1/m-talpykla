      ...
      <div class="row justify-content-center">
        <div class="col-md-4 files-in-a-rows">
          ...
          <div class="wrapper-icons"> <br>
            <a href="account.php?edit=<?php echo $row['id']; ?>" class="btn"><i class="fa fa-pencil" aria-hidden="true"></i></a>
            <a href="create_folder.php?delete=<?php echo $row['id']; ?>" class="btn"><i class="fa fa-trash" aria-hidden="true"></i></a>
            <a href="download.php?id=<?php echo $row['id']; ?>" download class="btn"><i class="fa fa-download" aria-hidden="true"></i></a>
          </div>
        </div>
      <?php endwhile; ?>
      </div>
