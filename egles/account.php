...
$total_pages = ceil($total_rows / $no_of_records_per_page);
      ...
      AND teachers.username='$username' LIMIT '$offset', $no_of_records_per_page" ) or die ($conn->error);
      }
      else{
    ...
    if ($update == true):
      ...
      <ul class="pagination">
    <li><a href="?pageno=1">Pirmas</a></li>
    <li class="<?php if($pageno <= 1){ echo 'disabled'; } ?>">
        <a href="<?php if($pageno <= 1){ echo '#'; } else { echo "?pageno=".($pageno - 1); } ?>">Praeitas</a>
    </li>
    <li class="<?php if($pageno >= $total_pages){ echo 'disabled'; } ?>">
        <a href="<?php if($pageno >= $total_pages){ echo '#'; } else { echo "?pageno=".($pageno + 1); } ?>">Sekantis</a>
    </li>
    <li><a href="?pageno=<?php echo $total_pages; ?>">Paskutinis</a></li>
</ul>
